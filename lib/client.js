...
.dstBalanceMeter{display:flex;align-items:center;width:clamp(92px,16vw,220px);height:20px;margin:0 8px}
...
.dstBalanceValue{flex:0 0 48px;margin-left:7px;color:var(--deepseek-theme-progress-color,#df929a);font-family:var(--deepseek-theme-progress-font,var(--dsw-font-family));font-size:11px;font-variant-numeric:tabular-nums;line-height:14px;text-align:right;text-shadow:0 0 5px rgba(224,66,91,.38);white-space:nowrap}
...
@media(max-width:760px){.dstBalanceMeter{width:86px;margin:0 4px}.dstSettingControls{grid-template-columns:1fr auto}.dstSelect{grid-column:1/-1}}
`;
